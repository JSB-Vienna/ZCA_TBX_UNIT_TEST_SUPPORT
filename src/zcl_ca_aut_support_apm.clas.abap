...
CLASS zcl_ca_aut_support_apm DEFINITION PUBLIC
                             FINAL
                             CREATE PUBLIC.
...
CLASS ZCL_CA_AUT_SUPPORT_APM IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    zif_apack_manifest~descriptor =
         VALUE #(
            group_id        = 'itinere.at'
            artifact_id     = 'zca_tbx_unit_test_support'
            version         = '1.0.0'
            repository_type = 'abapGit'
            git_url         = 'https://github.com/JSB-Vienna/zca_tbx_unit_test_support.git'
            dependencies    =
                  VALUE #(
                      ( group_id       = 'itinere.at'
